...
func FncPsglstMilegeSycmap() *sync.Map {

	// Inisialisasi variabel
	fnldta := &sync.Map{}

	// Select database and collection
	tablex := fncGlobal.Client.Database(fncGlobal.Dbases).Collection("psglst_milege")
	...
	for datarw.Next(contxt) {
		var object mdlPsglst.MdlPsglstMilegeDtbase
