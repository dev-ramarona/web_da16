...
func FncPsglstFrtaxsSycmap() *sync.Map {

	// Inisialisasi variabel
	fnldta := &sync.Map{}

	// Select database and collection
	tablex := fncGlobal.Client.Database(fncGlobal.Dbases).Collection("psglst_frtaxs")
	...
	for datarw.Next(contxt) {
		var object mdlPsglst.MdlPsglstFrtaxsDtbase
