...
export default function UixJeddahAgtnmeTablex({
  ...
  return (
    <>
      {/* Confirm update data */}
      <div
        className={`flexctr absolute z-20 pt-10 pb-2 ${
          confrm
      ...
      >
        <div className="afull flexctr flex-col bg-white rounded-lg shadow-md ring-2 ring-sky-800 overflow-hidden font-semibold">
          ...
          <div
            className={`whitespace-nowrap text-red-800 pt-1.5 ${
              agtnme.newidn == agtnme.agtidn || !agtnme.agtidn ? "hidden" : ""
            }`}
          >
        ...
        <table className="w-full">
          ...
          <tbody className="text-slate-700 bg-sky-100">
            {agtnul.map((log, idx) => (
              <tr
                className={`h-8 group ${
                  agtnme.agtnme == log.agtnme && rspupd != ""
                    ? rspupd == "failed"
                      ? "bg-red-300 shkeit"
                      : "bg-green-300 shkeit"
                    : ""
              ...
              >
                ...
                <td className="tdbody text-center">
                  <div
                    style={{
                      ...
                      width: `${
                        (agtnme.newidn || "New ID Agent").length * 0.58
                      }rem`,
                    }}
                  >
                ...
                <td className="tdbody text-center">
                  <div
                    style={{
                      ...
                      width: `${
                        (agtnme.newdtl || "New Detail Agent Name").length * 0.58
                      }rem`,
                    }}
                  >
                    <UixGlobalInputxFormdt
                ...
                <td className="tdbody text-center">
                  <div
                    style={{
                      ...
                      width: `${
                        (agtnme.rtlsrs || "RTL/SRS/NON").length * 0.58
                      }rem`,
                    }}
                  >
                    <UixGlobalInputxFormdt
                ...
                <td className="tdbody">
                  <div className="flexbtw">
                    ...
                    <button
                      className={`py-0.5 ${
                        log.prmkey == agtnme.prmkey && agtnme.agtidn != ""
                          ? "btnsbm"
                          : "btnoff"
                      }`}
                      disabled={
