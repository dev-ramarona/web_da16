...
import { MdlJeddahPnrsmrDefapi, MdlJeddahPnrsmrSearch } from "../model/mdlJeddahMainpr";

// Function get jeddah summary PNR
export async function ApiJeddahPnrsmrGetall(params: MdlJeddahPnrsmrSearch) {
    try {
        const rspnse = await ApiGlobalAxiospParams.post("/jeddah/pnrsmr/getall", params);
